...
{
    #[Route('/', name: 'admin_zone_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'admin_zone_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_zone/new.html.twig', [
            'zone' => $zone,
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}', name: 'admin_zone_show', methods: ['GET'])]
    public function show(Zone $zone): Response
    {
        return $this->render('admin_zone/show.html.twig', [
            'zone' => $zone,
        ]);
    }
    ...
    public function edit(Request $request, Zone $zone, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_zone/edit.html.twig', [
            'zone' => $zone,
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}', name: 'admin_zone_delete', methods: ['POST'])]
