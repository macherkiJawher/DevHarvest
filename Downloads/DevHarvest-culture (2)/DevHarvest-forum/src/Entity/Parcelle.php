...
use App\Entity\Culture; // Import Culture
...
class Parcelle
{
    ...
    {
        if ($this->cultureActuelle) {
            // Exemple simple de calcul du rendement
            $rendement = $this->superficie * 10; // Supposons que chaque m² de la parcelle donne 10 kg de rendement
            return "Rendement estimé : " . $rendement . " kg";
        }

        return "Pas de culture en cours";
    }
