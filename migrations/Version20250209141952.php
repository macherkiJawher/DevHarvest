 ...
 */
final class Version20250209141952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE role_enum CHANGE name name VARCHAR(180) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE role_enum CHANGE name name VARCHAR(255) NOT NULL');
    }
}
