 ...
 */
final class Version20250217080237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD nom VARCHAR(255) NOT NULL, ADD description LONGTEXT NOT NULL, ADD prixunitaire NUMERIC(10, 2) NOT NULL, ADD quantitestock INT NOT NULL, ADD image VARCHAR(255) DEFAULT NULL, ADD categorie VARCHAR(255) NOT NULL, DROP nom_produit, DROP quantite, DROP prix_unitaire');
    }
